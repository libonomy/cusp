...
func (app *CuspApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *CuspApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
