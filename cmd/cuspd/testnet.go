...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Cuspd testnet",
...
Example:
	...
	cmd.Flags().String(
		...
		"Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01psix,0.001flby)")
	return cmd
}
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	cuspConfig := srvconfig.DefaultConfig()
	cuspConfig.MinGasPrices = minGasPrices
