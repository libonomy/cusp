...
Supporting code can be found in the [networks directory](https://github.com/evdatsion/gaia/tree/master/networks) and additionally the `local` or `remote` sub-directories.
...
From the [networks/local directory](https://github.com/evdatsion/gaia/tree/master/networks/local):
...
The following should be run from the [networks directory](https://github.com/evdatsion/gaia/tree/master/networks).
