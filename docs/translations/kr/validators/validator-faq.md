...
테스트넷은 로치 전에 검증인 세팅을 확인할 수 있는 좋은 환경입니다. 테스트넷에 참가함으로 본인이 검증인 운영을 위해 준비해왔다는 것을 보여주는 기회가 될 수도 있습니다. 테스트넷에 관련된 정보는 [여기](https://github.com/evdatsion/cosmos-sdk/tree/develop/cmd/gaia/testnets) 와 [여기](https://github.com/evdatsion/testnets)에서 확인하실 수 있습니다.
