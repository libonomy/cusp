...
관련 코드는 [네트워크 디렉토리](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks)와 하단의 `local`과 `remote` 서브 디렉토리에서 찾으실 수 있습니다.
...
관련 코드 [networks/local 디렉토리](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks/local):
...
다음 환경은 [네트워크 디렉터리](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks)에서 실행하셔야 합니다.
