...
::: 提示 当前测试网
请查看[testnet repo](https://github.com/evdatsion/testnets)获取最新的公共测试网信息，包含了所使用的Cosmos-SDK的正确版本和genesis文件。
:::
...
只有SDK的版本和genesis文件不同。查看[testnet repo](https://github.com/evdatsion/testnets)
...
注意这里我们使用的是包含最新稳定发布版本的`master`分支。请查看[testnet repo](https://github.com/evdatsion/testnets)查看哪个版本的测试网需要哪一个Cosmos-SDK版本，在[SDK发布版](https://github.com/evdatsion/cosmos-sdk/releases)中对应的详细信息。
