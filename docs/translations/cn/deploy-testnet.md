...
支持代码可以在[networks目录](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks)中找到，还可以在`local`或`remote`子目录中找到。
...
在[networks/local目录](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks/local)中运行如下命令:
...
应该从[networks目录](https://github.com/evdatsion/cosmos-sdk/tree/develop/networks)运行下面的命令。
