...
我们将参与测试网络视为一个向社区展示你是有准备且有能力去运行验证人节点的方式。你可以在[这里](https://github.com/evdatsion/cosmos-sdk/tree/develop/cmd/gaia/testnets)和[这里](https://github.com/evdatsion/testnets)找到有关测试网的更多内容。
