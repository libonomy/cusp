...
func TestCuspCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "libonomy1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recover").String())
...
func TestCuspCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "libonomy1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "libonomy1pdfav2cjhry9k79nu6r8kgknnjtq6a7rykmafy", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "libonomy1909k354n6wl8ujzu6kmh49w4d02ax7qvlkv4sn", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "libonomy1v9plmhvyhgxk3th9ydacm7j4z357s3nhtwsjat", f.KeyAddress("test-recoverH4").String())
